                ...
                {about.work.experiences.map((experience, index) => (
                  ...
                  >
                    ...
                    {experience.subRoles && experience.subRoles.length > 0 ? (
                      /* LinkedIn-style grouped sub-roles */
                      <Text
                    ...
                    {experience.subRoles && experience.subRoles.length > 0 ? (
                      <Column fillWidth gap="l" paddingLeft="20">
                        {experience.subRoles.map((subRole, subIndex) => (
                          <Column
                            key={`${experience.company}-sub-${subIndex}`}
                            fillWidth
                          >
                            <Row
                              fillWidth
                              ...
                              {subRole.achievements.map(
                                (
                                  ...
                                  <Text
                                    ...
                                    key={`${experience.company}-sub-${subIndex}-${achIndex}`}
                                  >
                                    {achievement}
                                  </Text>
                                ),
